      ...
      <div className="bg-gradient-to-b from-[#6cc3e1] via-[#346aad]  to-black overflow-hidden relative">
        ...
        >
          <div className="flex items-center gap-4 flex-col justify-between min-h-[60rem]">
            <div className="lg:text-[20rem] md:text-[14rem] sm:text-[10rem] text-[6rem] sm:block cursor:pointer flex flex-nowrap  relative font-bold tracking-normal">
              GENESIS <span className="text-[50px] ml-8  absolute left-[1270px] top-[290px] hidden lg:block cursor:pointer tracking-normal">4.0</span>
            </div>
