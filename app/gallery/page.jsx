...
const Gallery = () => {
  return (
    <>
      <div className="bg-custom-gradient min-h-screen p-4 md:px-8 xl:px-12 lg:px-12 py-40">
        <p className="text-[#fffae1] font-normal text-[2.25rem] md:text-[5rem] text-center pt-4 pb-8">
          Our Memories
        </p>
        <Carousel />
        <div className=" flex flex-col min-h-screen p-4 md:px-8 lg:px-12 py-5 pt-[150px]">
          <div className="w-full flex flex-col gap-6">
            <div className="flex flex-col items-center">
              <p className="text-[#fffae1] font-normal text-[2.25rem] md:text-[5rem]">
                Gallery
              </p>
              <p
