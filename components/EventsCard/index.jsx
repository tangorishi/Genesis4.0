      ...
      <DialogTrigger>
        <div className="flex justify-center items-center">
          <div
            ...
            md:w-[25rem] md:h-[45rem] gap-4 md:gap-6 cursor-pointer rounded-[4px] border
          ...
          >
            <div className="flex flex-col items-center justify-start gap-1 p-4 pb-0">
              ...
              <p
                className="font-medium text-[3.5rem] md:text-[2.5rem]"
                style={{
                  background:
              ...
              <p className="text-white text-[1.5rem] md:text-[1.1rem]">
                Lorem ipsum dolor sit amet consectetur{" "}
              </p>
            </div>

            <div className="flex gap-4 mt-0 pb-4 text-[1.75rem] md:text-[1rem]">
