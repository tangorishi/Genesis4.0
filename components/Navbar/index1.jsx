        ...
        <>
            <nav className="absolute sm:z-[2] w-full flex items-center xl:justify-center px-4 pt-8">
                <div className="flex items-center justify-between w-full">
                    <img src="/path-to-your-left-image.jpg" alt="Left Image" className="hidden xl:block h-10" />
                    <div
              ...
              bg-opacity-60 backdrop-blur-xl space-x-2"
                    ...
                    <img src="/path-to-your-right-image.jpg" alt="Right Image" className="hidden xl:block h-10" />
                    <button
                        id="menu-btn"
